...
docker run --rm --network cm-desk_default -v /c/senthil/CM-Desk:/app -w /app \
  -e DATABASE_URL=postgresql://postgres:postgres@cm-desk-postgres:5432/trading_db \
  -e REDIS_URL=redis://cm-desk-redis:6379 \
