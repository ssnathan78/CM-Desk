...
CM-Desk is a **personal** app for placing and managing Indian index-options trades through **Zerodha Kite Connect**. You run it yourself (laptop Docker or a Linux server). It is not a hosted product and it does not share data with anyone else.
